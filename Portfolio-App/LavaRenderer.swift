...
final public class LavaRenderer: NSObject, MTKViewDelegate {
    // `Uniforms` moved to LavaModels.swift
...
public struct MetalLavaView: UIViewRepresentable {
    ...
    public func updateUIView(_ uiView: MTKView, context: Context) {
        ...
        context.coordinator.scratch = LavaBlobFactory.makeBlobData(from: blobs, containerSize: containerSize, time: time, showReservoir: showReservoir, detailRect: detailRect)
